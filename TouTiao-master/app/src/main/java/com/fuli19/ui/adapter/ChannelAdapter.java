...
import com.fuli19.R;
import com.fuli19.listener.OnChannelDragListener;
    ...
    protected void convert(final BaseViewHolder helper, final Channel channel) {
        switch (helper.getItemViewType()) {
            case Channel.TYPE_MY:
                ...
                helper.setText(R.id.tvTitle, channel.type)
            ...
            case Channel.TYPE_MY_CHANNEL:
                //我的频道列表
                helper
                        .setVisible(R.id.ivDelete, mIsEdit && !(channel.type.equals("推荐")))//编辑模式就显示删除按钮
                ...
                helper.setText(R.id.tvChannel, channel.type).setOnClickListener(R.id.ivDelete, new View.OnClickListener() {
                    @Override
...
//                            GlobalParams.mRemovedChannels.add(channel);
            ...
            case Channel.TYPE_OTHER_CHANNEL:
                //频道推荐列表
                helper.setText(R.id.tvChannel, channel.type).setVisible(R.id.ivDelete, false)
    ...
    private void startEditMode(boolean isEdit) {
        ...
        for (int i = 0; i < visibleChildCount; i++) {
            ...
            if (imgEdit != null) {
                ...
                imgEdit.setVisibility(isVis && isEdit && !mData.get(i).type.equals("推荐") ? View.VISIBLE : View.INVISIBLE);
            }
        }
    }
}
